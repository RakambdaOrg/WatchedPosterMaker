...
object JacksonUtils {
    ...
    object SQLTimestampDeserializer : JsonDeserializer<ZonedDateTime>() {
        override fun deserialize(jsonParser: JsonParser, ctxt: DeserializationContext): ZonedDateTime {
            return ZonedDateTime.ofInstant(Instant.ofEpochSecond(jsonParser.valueAsLong), ZoneId.of("UTC")).withZoneSameInstant(systemDefault())
        }
    }
}